...
public class Quiz extends JFrame  implements ActionListener{
    ...
    Quiz(String name){
        ...
        setLayout(null);
         ...
         ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/q7.jpg"));
         JLabel image=new JLabel(i1);
         image.setBounds(00,00,1420,300); 
         add(image);
